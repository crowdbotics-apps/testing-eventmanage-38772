...
## Project Structure
    ...
    ├── testing_eventmanage_38772  # Django project configurations
...
1. Clone this repo and `cd testing_eventmanage_38772`
...
2. Clone this repo and `cd testing_eventmanage_38772`
